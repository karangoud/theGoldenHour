...
//                    ambRef.updateChildren(hopperUpdates);
    ...
    public void Emergency(View view) {
        ...
        DatabaseReference Emergencystatus = FirebaseDatabase.getInstance().getReference().child("Check");
        HashMap<String,String>EmergencyData = new HashMap<>();
        EmergencyData.put("Emergency","True");
        Emergencystatus.setValue(EmergencyData);
        try {
